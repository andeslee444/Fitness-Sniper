...
- [ ] **Phase 1: Infrastructure Hardening** - Fix the invisible bugs that silently destroy auth sessions, corrupt timezone rendering, and return unparseable API errors
- [ ] **Phase 2: Data Foundation** - Install TanStack Query and the `/api/calendar` route that power all real-time UI
